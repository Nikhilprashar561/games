      ...
      <header className="sticky top-0 z-40 w-full backdrop-blur-xl bg-white/85 dark:bg-[#05070b]/90 border-b border-slate-200/80 dark:border-slate-800/80 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            {/* Right Actions: Mode, Wallet, Add Money & Auth */}
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              {user ? (
                <div className="relative flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-1.5 px-3 py-1.5 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 font-extrabold text-xs sm:text-sm">
                  ...
                  {/* Dropdown Menu */}
                  {dropdownOpen && (
                    <div className="absolute right-0 top-12 mt-2 w-60 glass-panel rounded-2xl p-2 shadow-2xl z-50 border border-slate-200 dark:border-slate-800">
