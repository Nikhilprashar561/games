        ...
        <div className="glass-panel rounded-3xl p-6 sm:p-10 border border-slate-200/80 dark:border-slate-800/80 shadow-2xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
            ...
            <div className="lg:col-span-6 space-y-6 text-left">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 dark:text-white tracking-tight leading-tight font-['Space_Grotesk']">
                Welcome to <br />
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                ...
                <a
                  href="#games-section"
                  className="px-6 py-3.5 rounded-2xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 font-bold text-base border border-slate-300 dark:border-slate-700 transition-all flex items-center justify-center"
                >
                  Explore All 7 Games
                </a>
              </div>
              ...
              {/* Feature Badges */}
              <div className="pt-4 border-t border-slate-200 dark:border-slate-800/80 grid grid-cols-3 gap-2 text-xs font-bold text-slate-500 dark:text-slate-400">
