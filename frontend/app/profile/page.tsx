...
import { User, Wallet, ShieldCheck, ArrowLeft, Gamepad2, BarChart3, Filter, PlusCircle } from 'lucide-react';
...
export default function ProfilePage() {
  const { user, fetchMatchHistory } = useAuth();
  ...
  return (
    <ProtectedRoute>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-8">
        ...
        {/* Top Header Card */}
        <div className="glass-panel rounded-3xl p-6 sm:p-10 border border-slate-200/80 dark:border-slate-800/80 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
            ...
            <div className="flex items-center space-x-5">
              <div className="relative">
                ...
                />
                <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-emerald-500 border-2 border-white dark:border-slate-900"></div>
              </div>

              <div>
                <div className="inline-flex items-center space-x-1.5 px-3 py-0.5 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 text-xs font-bold uppercase mb-1">
                  <ShieldCheck className="w-3.5 h-3.5" />
                  <span>Verified Gamer Account</span>
                </div>
            ...
            <div className="flex items-center gap-4 w-full md:w-auto">
              <div className="p-5 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex flex-col justify-center min-w-[180px]">
                <div className="flex items-center space-x-1.5 text-xs font-extrabold text-emerald-600 dark:text-emerald-400 uppercase">
                  <Wallet className="w-4 h-4" />
                  <span>Real Money Wallet</span>
                </div>
                <p className="text-3xl font-black text-emerald-600 dark:text-emerald-400 mt-1 font-['Space_Grotesk']">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2 text-sm font-extrabold text-slate-900 dark:text-white font-['Space_Grotesk']">
            ...
            <button
              ...
              className={`px-4 py-2.5 rounded-xl font-bold text-xs sm:text-sm whitespace-nowrap transition-all border ${
                selectedGameSlug === 'all'
                  ...
                  : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 border-slate-200 dark:border-slate-700 hover:border-emerald-500/40'
              }`}
            >
              🎮 All Games Overview
            </button>
        ...
        {/* Metrics Grid */}
        <div className="glass-panel rounded-3xl p-6 sm:p-10 border border-slate-200/80 dark:border-slate-800/80 shadow-2xl space-y-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-200 dark:border-slate-800">
            ...
            {selectedGameInfo && (
              <div className="flex items-center space-x-3 bg-slate-100 dark:bg-slate-800/80 p-2.5 rounded-2xl border border-slate-200 dark:border-slate-700">
                <img
                ...
                />
                <div>
                  <p className="text-xs font-extrabold text-slate-900 dark:text-white">{selectedGameInfo.title}</p>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 text-center">
              <p className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase">Total Matches</p>
              <p className="text-3xl font-black text-slate-900 dark:text-white mt-1 font-['Space_Grotesk']">
                {stats.totalMatches}
              </p>
            ...
            <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 text-center">
              <p className="text-xs font-bold text-emerald-600 dark:text-emerald-400 uppercase">Win Rate</p>
              <p className="text-3xl font-black text-emerald-600 dark:text-emerald-400 mt-1 font-['Space_Grotesk']">
                {stats.winRate}%
              </p>
            ...
            <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 text-center">
              <p className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase">Net Earnings</p>
          ...
          <div className="space-y-4">
            ...
            {loading ? (
              ...
              <div className="text-center py-12 px-4 rounded-2xl bg-slate-50 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800">
              ...
              <div className="overflow-x-auto rounded-2xl border border-slate-200 dark:border-slate-800">
                <table className="w-full text-left text-xs sm:text-sm">
                  <thead className="bg-slate-100 dark:bg-slate-900 text-slate-500 dark:text-slate-400 font-extrabold uppercase tracking-wider text-[11px]">
                    <tr>
